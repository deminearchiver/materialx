...
export type DynamicOnlyColorTokens<T> = {
...
export type DynamicColorTokens<T> = BaselineColorTokens<T> &
  DynamicOnlyColorTokens<T>;

export type ColorTokens<T> = DynamicColorTokens<T>;

export const createBaselineColorTokens =
  (): BaselineColorTokens<CSSVarFunction> => {
    const template: BaselineColorTokens<null> = {
      background: null,
      onBackground: null,
      surface: null,
      surfaceDim: null,
...
export const createDynamicOnlyColorTokens =
  (): DynamicOnlyColorTokens<CSSVarFunction> => {
    const template: DynamicOnlyColorTokens<null> = {
...
export const createColorTokens = (): ColorTokens<CSSVarFunction> => {
  return {
    ...createBaselineColorTokens(),
    ...createDynamicOnlyColorTokens(),
  };
};
...
const BASELINE_COLOR_VALUES: Record<
  ...
  Record<
    Contrast,
    (palette: BaselinePaletteTokens<string>) => BaselineColorTokens<string>
  >
> = {
  light: {
    normal: (palette) => ({
...
export const colorValuesFromPalette = (
  color: BaselineColorTokens<string>,
  palette: BaselinePaletteTokens<string>,
  theme: Theme,
  contrast: Contrast = "normal"
